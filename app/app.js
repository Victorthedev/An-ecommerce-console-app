...
//store visitor's name for later use
let visitor = user;

//welcome message
console.log(`Welcome ${visitor}, What are you shopping for today?`);
...
function checkout() {
  if (cart.length === 0) {
    ...
    console.log(`Your Order has been placed, ${visitor}!`);
